...
const fullName = inventors.map(function(names){
...
console.log(fullName)
  ...
  const sortBDay = inventors.sort(function(a, b){
...
let sum = inventors.reduce(function(acc,num){
...
console.log(sum);
  ...
  people.forEach(function(name){
      ...
      reversePeople.push(splitName[1] + " " + splitName[0])
  })
  ...
  const instances = data.reduce(function(acc, el){
  ...
  const isEveryOverNineteen = devs.every(function(dev){
      return dev.year <= 2001;
  })

  console.log(isEveryOverNineteen);
  ...
  let findId = comments.find(function(ids){
      return ids.id === 823423;
  })
  ...
  let indexOfId = comments.findIndex(function(ids){
      return ids.id === 123523;
  })
